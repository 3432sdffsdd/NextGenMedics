import { FiHome, FiBookOpen, FiClipboard, FiCalendar, FiLayers, FiZap, FiTrendingUp, FiDatabase, FiAlertCircle, FiPackage, FiTarget, FiFilm, FiMap } from 'react-icons/fi'
...
const navItems = [
  ...
  { to: '/student/fcps-planner', label: 'FCPS Study Planner', icon: FiMap },
